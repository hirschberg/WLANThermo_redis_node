...
/* 
   Load SVG into Webpage
   ========================================================================== */
  //
  $(".logo").load('public/img/logo.svg');
/* 
  ...
  $('.meta .shutdown a').click(function(event) {
    event.preventDefault();
    $(this).parent().find('.tooltip').fadeToggle();
  });

  $('body').on('click', '.tempbox h2 span', function() {
      $(this).parents('.tempbox').toggleClass('kt gt');
      alert('todo: change gauge');
  });
...
JustGage.prototype.refresh = function(val, min, max) {
  ...
  var obj = this;
  var displayVal, color, min = min || null, max = max || null;
